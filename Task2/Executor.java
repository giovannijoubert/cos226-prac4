...
public class Executor
{
	...
	private PeekConsensus ConsensusObject; //Consensus protocol implemented - change to PeekConsensus for practical
	...
	public Executor(int threadCount)
	{
		...
		ConsensusObject = new PeekConsensus(threadCount); //change to PeekConsensus for practical
	}
